...
* tasks
** backlog
*** [refactor][ed] no need for lamdba(e) inside of $event
*** [refactor][ed] add/edit article should have 2 submit buttons: save, submit
    - no need for JS (#article a.submit)
*** [ed] home in prinav
*** TODO [ed] maintain article approve/reject history in article
    :CLOCK:
