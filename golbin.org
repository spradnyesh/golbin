...
* tasks
** backlog
*** [bug][fed] correct the dates of the 3 new articles uploaded
*** TODO [reports] check GA data
    ...
    :END:
*** [fe] prod should use minified and versioned css
*** [fed] inline images
...
*** [bug][fe] correct timezone in articles listings in home/index pages
*** [ed] do while saving article
    - [ ] remove all the '<p> +&nbsp +</p>' and '<div> +&nbsp +</div>'
    - [ ] convert all <div> into <p>???
...
*** TODO [ed] editor should be able to approve/reject articles
    ...
    :END:
*** [bug][fe] tos/privacy/author-index/tag-index pages show 'home' highlighted in prinav
...
**** DONE [fed] datetime
     ...
     :END:
     :PROPERTIES:
     :ARCHIVE_TIME: 2012-12-24 Mon 18:42
     :END:
