...
*** [lang] populate *current-dimensions-string* for every request and make it thread-safe
    - dev: url params, w/ fallback on master@config
    - prod: url
*** [lang] utf-8 in both fe and ed (including RTE)
*** [lang] font in RTE
*** [lang] decide b/n cl-l10n/cl-i18n
*** [lang] externalize strings from code, add library code
