...
*** TODO [fe][ed] get back to lisp style css and js
    :CLOCK:
    ...
    - [ ] need to figure out a solution for ed issue of getUrlParameter
*** TODO [bug][fe] nav hover not working for prod
    :CLOCK:
    :END:
