...
*** TODO [ed] author registration page
    ...
    - why register
|------------------------------+--------+---------+-------------------------------------|
|                              | Google | Golb.in | Description                         |
|------------------------------+--------+---------+-------------------------------------|
| Courier delay for cheque     | O      | X       | immediate NEFT transfer             |
|------------------------------+--------+---------+-------------------------------------|
| Wait time of 6 months        | O      | X       | already completed                   |
| for ads to appear on website |        |         |                                     |
|------------------------------+--------+---------+-------------------------------------|
| Approval of website content  | O      | X       | already completed                   |
|------------------------------+--------+---------+-------------------------------------|
| Search Engine Optimization   | O      | X       | we do it for you                    |
|------------------------------+--------+---------+-------------------------------------|
| Performance                  | O      | X       | we do it for you                    |
|------------------------------+--------+---------+-------------------------------------|
| Income                       | 100%   | 70%     | 30% to cover costs                  |
|------------------------------+--------+---------+-------------------------------------|
| Hosting cost                 | O      | X       | included in 30%                     |
|------------------------------+--------+---------+-------------------------------------|
| Marketing                    | O      | X       | we do it for you                    |
|------------------------------+--------+---------+-------------------------------------|
| Stand on shoulders of giants | X      | O       | get benefit due to users            |
|                              |        |         | visiting other pages on the website |
|------------------------------+--------+---------+-------------------------------------|
| Minimum payment amount       | O      | X       | monthly payment                     |
|------------------------------+--------+---------+-------------------------------------|
| Detailed performance reports | X      | O       | on same dashboard                   |
|------------------------------+--------+---------+-------------------------------------|
|------------------------------+--------+---------+-------------------------------------|
|------------------------------+--------+---------+-------------------------------------|
|------------------------------+--------+---------+-------------------------------------|
