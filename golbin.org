...
* tasks
** backlog
*** [bug] remove subcat=NIL from 'forgetting "forgive and forget"'
*** [bug] correct date in photo@model (insert, read) (universal timestamp, not string/object)
...
*** [bug][fed] invalid DB requests should not go to debugger, but fail
*** [seo] robots.txt
*** TODO [performance] js
    :CLOCK:
    :END:
