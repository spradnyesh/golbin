...
* tasks
** backlog
*** [bug][fe] home page giving a 500
*** [bug][fe] article page giving a 404
*** TODO [fe][ed] article should have comment count
    :CLOCK:
...
** LOCNW: lines of code not written
   ...
   - summary:
   - body:
** TODO forget "forget and forgive"
   :CLOCK:
   CLOCK: [2012-12-11 Tue 16:00]--[2012-12-11 Tue 17:21] =>  1:21
   :END:
   - cat/subcat:
   - tags: radiolab, ted, ted talks, eternal sunshine of the spotless mind, memory, erase memory, inception, anisomycin, ethics
   - author:
   - lead image:
   - summary:
   - body:
