...
* tasks
** backlog
*** [ed] support non-js browsers too
*** [bug][ed] fix subnav overflow css
*** [ed] refactor js for form submission
*** [ed] clean up non-ajax routes
*** TODO [ed] accounts
    :CLOCK:
    CLOCK: [2013-08-19 Mon 14:30]--[2013-08-19 Mon 14:35] =>  0:05
    CLOCK: [2013-08-19 Mon 14:18]--[2013-08-19 Mon 14:30] =>  0:12
    :END:
**** regenerate token card
**** Archive                                                        :ARCHIVE:
***** DONE change email
...
***** DONE change password
      CLOSED: [2013-08-19 Mon 17:12]
      :CLOCK:
      CLOCK: [2013-08-19 Mon 17:02]--[2013-08-19 Mon 17:12] =>  0:10
      CLOCK: [2013-08-19 Mon 16:13]--[2013-08-19 Mon 16:23] =>  0:10
      :END:
      :PROPERTIES:
      :ARCHIVE_TIME: 2013-08-19 Mon 17:12
      :END:
*** [fe] "load more" pagination for comments
*** [fe] tooltips in comments
*** [bug][fe] spelling mistake in
    - [ ] "yanni"
    - [ ] "tags" in "mr"
*** [fe] put id in comments so that they are easy to delete
*** [fe] like/unlike for comments
*** [ed] token key (crumb) should be time limited
*** [ed] admin should be able to approve author
*** [ed] editor should be able to approve article
*** [ed] remove "/photo/" from routes
    - only /ajax/photo/ is needed
*** TODO [security][fed] process output
    :CLOCK:
    ...
    - [-] ed:
      ...
      - [ ] disallow script tags in body
*** [ed] forgot password logic
*** [utils] replace utils/locale w/ cl-locale
*** [ed] move ?lang -> cookie(ed-lang) into template
    - rename cookie name from ed-lang to lang
    - because the cookie domain is unique
*** [ed] mr/hi ckeditor should show devanagari font
...
*** [ed] emails to golb_in
    ...
    - [ ] on article(s) submit (add/edit)
*** [ed] emails to authors
    - [ ] monthly report
    - [ ] approval of add/edit article(s)
*** [fe] collect emails (submitted in comments) for spamming
*** TODO [ed] translations for author registration
    :CLOCK:
...
**** DONE [ed] user should be powerless after registration until his account is approved
     CLOSED: [2013-08-19 Mon 14:14]
     :CLOCK:
     CLOCK: [2013-08-19 Mon 14:12]--[2013-08-19 Mon 14:14] =>  0:02
     :END:
     :PROPERTIES:
     :ARCHIVE_TIME: 2013-08-19 Mon 14:14
     :END:
** TODO refactor
   :CLOCK:
