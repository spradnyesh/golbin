...
* tasks
** backlog
*** [#B] [bug][ed] add-photo-attribution should apply to only newly added photos while editing article
*** [ed] article validation
...
*** [fed] put form processing js into utils so that it can be used from both fe and ed
