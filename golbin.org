...
* tasks
** backlog
*** [ed] db-reconnect should reconnect all db's (all langs, in same envt???)
*** TODO [fe][ed][util] lisp style error handling
    :CLOCK:
...
*** [bug][fe] nav hover not working for prod
*** TODO [fe] theme
    :CLOCK:
...
*** [bug][ed] select/upload photo not working for prod
*** [fe][ed][util] lisp style error handling
    - http://psg.com/~dlamkins/sl/chapter23.html
    - http://www.gigamonkeys.com/book/beyond-exception-handling-conditions-and-restarts.html
    - http://video.google.com/videoplay?docid=448441135356213813&q=lisp
*** [bug][fe] carousel working even on data.status="failure"
...
**** DONE [bug][fe] cloud background clipping in some browsers sometimes
     CLOSED: [2013-03-06 Wed 17:41]
     :CLOCK:
     CLOCK: [2013-03-06 Wed 17:30]--[2013-03-06 Wed 17:41] =>  0:11
     :END:
     :PROPERTIES:
     :ARCHIVE_TIME: 2013-03-06 Wed 17:41
     :END:
