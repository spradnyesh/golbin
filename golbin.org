...
* backlog
** [utils] move common functionality (including (partial) views to web-utils
   - [ ] login
** [tests] write tests for web-utils
** [refactor] split utils into a separate project web-utils
...
** wrote (not published)
*** TODO ml-305: univariate linear regression
    :CLOCK:
...
*** TODO ml-304: gradient descent and learning rate "α"
    :CLOCK:
