...
* backlog
** won't do                                                        :ARCHIVE:
*** migrate linode to 64-bit
:PROPERTIES:
:ARCHIVE_TIME: 2015-10-03 Sat 15:29
:END:
:CLOCK:
- State "UNDERGOING" from "BLOCKED"    [2015-10-03 Sat 19:54]
- State "CANCELLED"  from              [2015-10-03 Sat 15:29]
:END:
   - because of gryffin dependency on mongodb 64-bit
   - steps
     - cd ~/quicklisp/local-projects
       - add golbin, web-utils
     - cd ~/quicklisp/dists/quicklisp/software/cl-gd-0.6.0
       - rm cl-gd-glue.so
       - make
     - swank
       - sbcl
       ...
       - emacs
         - slime-connect
           - http://blog.quicklisp.org/2011/08/going-back-in-dist-time.html
             ...
             - (install-dist "http://beta.quicklisp.org/dist/quicklisp/2014-02-11/distinfo.txt" :replace t)
           - (ql:quickload :golbin)
           - (in-package :hawksbill.golbin.editorial)
           - (ed-start)
           - (in-package :hawksbill.golbin.frontend)
           - (fe-start)
*** investigate https://github.com/redline6561/coleslaw
...
*** CANCELLED [#B] [bug][web-utils] mocks defined in web-utils-tests are overriding library functions in golbin code
    CLOSED: [2014-02-20 Thu 18:42]
    :LOGBOOK:
    - State "CANCELLED"  from "DONE"       [2014-02-20 Thu 18:42] \\
      not a bug; just needed to restart slime
    :END:
    :CLOCK:
    CLOCK: [2014-02-20 Thu 18:40]--[2014-02-20 Thu 18:42] =>  0:02
    :END:
    :PROPERTIES:
    :ARCHIVE_TIME: 2014-02-20 Thu 18:42
    :END:
*** DONE [refactor] db-execute
    CLOSED: [2014-02-20 Thu 18:42]
    :CLOCK:
    CLOCK: [2014-02-20 Thu 18:30]--[2014-02-20 Thu 18:40] =>  0:10
    :END:
    :PROPERTIES:
    :ARCHIVE_TIME: 2014-02-20 Thu 18:42
    :END:
*** DONE move golbin/common/secrets to web-utils
    CLOSED: [2014-02-23 Sun 10:43]
    :PROPERTIES:
    :ARCHIVE_TIME: 2014-02-23 Sun 10:43
    :END:
*** CANCELLED migrate to openshift
CLOSED: [2015-10-03 Sat 20:23]
:PROPERTIES:
:ARCHIVE_TIME: 2015-10-03 Sat 20:24
:END:
:CLOCK:
- State "CANCELLED"  from              [2015-10-03 Sat 20:23] \\
  look-n-feel is in terrible shape; will take too much time and effort to restore => not doing
:END:
**** get golbin to work locally
:CLOCK:
CLOCK: [2015-10-03 Sat 19:53]--[2015-10-03 Sat 20:25] =>  0:32
CLOCK: [2015-10-03 Sat 17:22]--[2015-10-03 Sat 18:25] =>  1:03
CLOCK: [2015-10-03 Sat 15:30]--[2015-10-03 Sat 16:47] =>  1:17
:END:
1. # apt-get install libgd-dev
2. sbcl (1.2.14.debian)
3. http://blog.quicklisp.org/2011/08/going-back-in-dist-time.html
   - (in-package :cl-user)
   - ;; (use-package :ql-dist)
     - ;; (available-versions (dist "quicklisp"))
     - ;; (install-dist "http://beta.quicklisp.org/dist/quicklisp/2014-02-11/distinfo.txt" :replace t)
   - (ql:quickload :cl-gd)
4. cd ~/quicklisp/dists/quicklisp/software/cl-gd-0.6.0
   - rm cl-gd-glue.so
   - make
5. cd ~/quicklisp/local-projects
   - add golbin, web-utils
6. emacs: slime
   - ;; (ql:quickload :web-utils)
   - (ql:quickload :golbin)
   - (in-package :hawksbill.golbin.editorial)
   - (ed-start)
   - (in-package :hawksbill.golbin.frontend)
...
**** DONE ml-504: cost function for logistic regression
    CLOSED: [2014-02-17 Mon 15:33]
    :CLOCK:
    ...
    :END:
     :PROPERTIES:
     :ARCHIVE_TIME: 2014-02-17 Mon 15:33
     :END:
    - toc:
...
**** DONE ml-505: simplified cost function and gradient descent for logistic regression
    CLOSED: [2014-02-17 Mon 15:33]
    :CLOCK:
...
**** DONE ml-506: multi-class classification
    CLOSED: [2014-02-17 Mon 15:33]
    :CLOCK:
