...
* tasks
** backlog
*** TODO [editorial] RTE for articles
    :CLOCK:
    ...
    - ckeditor.com + spellcheck.net
*** [editorial] non-lead photos for article (during new/edit). author should be able to use URL generated after uploading photo
*** [model] change photo new-filename logic to handle for collision
...
| Blue   | Draft     |
    ...
    - #views
      ...
      - this half-year
      - this year
*** TODO [model] add categories to article photos
    :CLOCK:
...
*** 100 2-digit salts for every author for login
    - [ ] change to db
    - [ ] change to login get/post
    - [ ] need to send email of these 100 salts on successful registration
