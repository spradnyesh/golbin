...
*** TODO [fe] init prod sites
    ...
    - sites
      - [X] www
      - [ ] mr
    - [ ] remove 'these are ads-?', 'this is the footer'
    - [ ] add articles
...
*** [fe] footer
    - [ ] copyright mark
    - [ ] copyright page
    - [ ] contact us page => email address (golbin@rocketmail.com)
*** TODO [fe] comments
    :CLOCK:
    ...
    - [-] fe
      - [X] get
      - [X] post
      - [ ] check for empty name/email/url/body
...
*** TODO [reports] check GA data
    ...
    :END:
*** [fe][ed] gravatar for author images
...
** LOCNW: lines of code not written
   ...
   - summary:
   - body:
** TODO forget "forgive and forget"
   :CLOCK:
   ...
   :END:
   - cat/subcat: science/--
   - tags: forgive and forget, radiolab, ted, ted talks, eternal sunshine of the spotless mind, memory, erase memory, inception, anisomycin, ethics, memento, Albert Einstein, Einstein, Studs Terkel, Anisomycin, ptsd, amnesia, clive wearing, oliver sacks, elizabeth loftus, scott fraser, andrei codrescu, 101 damnations
