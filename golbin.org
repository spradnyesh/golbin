...
* tasks
** backlog
*** [fe] validate comments
    - check for empty name and (email or url) and body
    - both js and server side
*** [ed] disallow access to non-js browsers
*** TODO ajaxify comments
    :CLOCK:
    CLOCK: [2013-08-13 Tue 18:46]--[2013-08-13 Tue 19:21] =>  0:35
    CLOCK: [2013-08-13 Tue 17:37]--[2013-08-13 Tue 18:03] =>  0:26
    :END:
*** [fe][performance] improve load time
    - [ ] combine css/js
    - [ ] replace ubuntu w/ standard form
      - 'Ubuntu', Arial, sans-serif
    - [ ] load devanagari font for only hindi/marathi
