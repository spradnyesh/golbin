...
* tasks
** backlog
*** [db] correct the inline images of prod articles
*** TODO [ed] re-populate form on error after POST->GET
    :CLOCK:
...
*** [bug][fe] move related articles carousels outside of a-body
    - so that lots of inline images in a-body will not interfere visually w/ them
*** [bug][ed] photo-pane not working in ff
    - test in other browsers too
*** [ed] error messages
    - inline photos in articles should be of /static/photos/*.jpeg
*** [fe] error messages
    - spam comment
*** [fe] pull js out into a static file like css
...
** TODO writing flavors
   ...
   - tags:
   - lead image:
   - summary: Feedback from my wife takes me onto a journey that helps me discover the different styles of writing.
   - body:
As a birthday gift to my wife, I released this [[www.golb.in][website]] on 23rd Dec and uploaded the articles that I had written already. I asked my wife to read them and give me feedback. Personally, I would've rated them in the order of:
...
[[Discovering%20the%20joy%20of%20writing][Discovering the joy of writing]] was my first article and I had written it without a very clear mind and without much purpose. For the other 2 articles, on the other hand, I had done quite some research and had taken sufficient time to write and rewrite them. How was it then, that my wife liked [[Discovering%20the%20joy%20of%20writing][Discovering the joy of writing]] the most? I asked her and she told me that she liked writings (articles, novels, etc) that talk to her. [[Discovering%20the%20joy%20of%20writing][Discovering the joy of writing]] was just like that. [[Forgetting%20"forgive%20and%20forget"][Forgetting "forgive and forget"]] and [[What%20makes%20you,%20you?][What makes you, you?]] however are, what she calls, gyaan sessions, i.e. "boring".

I thought, if I am to write, I should understand the different styles of writing. And I am not talking here about grammar, but the different genres, if you will, of writing. I thought about it a lot and the following are the different styles that I could recognize:
     - Imagination: Story telling, novels, poems fall into this category.
     ...
     - Blog: Sometimes you find out something interesting or clever, most probably in your domain of work, and you want to share it with your friends and/or the community at large. You also want to note it down somewhere where it is easy to find it later if you need. Many people use personal blogs to accomplish this.

I am sure there will be many more styles. But these are the ones that I could think of. While enumerating them, I realized that


I also thought of doing an experiment. I decided to write this article in the "talk" style that my wife had told me earlier. Through this experiment, I wanted to check whether I have the ability or knack of writing in this style and also check what are the views and opinions of my readers. It is for this reason that you will find no links pointing out to [[wikipedia.com][wikipedia]] or other sites from this article. It is all my thoughts, and my thoughts only :) So what do you think?
   - notes:
     - styles
