...
** backlog
*** [fed] ed-lang -> lang
*** [ed] r-account-* should have ajax counterparts
    - add init in js
*** [bug][ed] sprite image in logged-out pages
*** [ed][reports] investigate GA users
*** [bug][ed] add-photo-attribution should apply to only newly added photos while editing article
...
**** DONE refactor js forms
     CLOSED: [2013-08-23 Fri 11:47]
     :CLOCK:
     CLOCK: [2013-08-23 Fri 11:42]--[2013-08-23 Fri 11:47] =>  0:05
     :END:
     :PROPERTIES:
     :ARCHIVE_TIME: 2013-08-23 Fri 11:47
     :END:
** TODO refactor
   :CLOCK:
