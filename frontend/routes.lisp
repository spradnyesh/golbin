...
(define-route fe-r-cat ("/category/:cat/") (fe-v-cat cat))
(define-route fe-r-cat-page ("/category/:cat/:page" :parse-vars (list :page #'parse-integer)) (fe-v-cat cat page))
(define-route fe-r-cat-subcat ("/category/:cat/:subcat/") (fe-v-cat-subcat cat subcat))
(define-route fe-r-cat-subcat-page ("/category/:cat/:subcat/:page" :parse-vars (list :page #'parse-integer)) (fe-v-cat-subcat cat subcat page))
