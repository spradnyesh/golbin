...
(defun v-tos ()
  (fe-page-template
   ...
   (htm (:div :id "articles"
              (:h2 "Terms of Use")
              (:div (:h3 "Important Information")
                    (:p "You should carefully read the following Terms and Conditions. Your purchase or use of our products implies that you have read and accepted these Terms and Conditions."))
              (:div (:h3 "Ownership")
              ...
              (:div (:h3 "Intellectual Property Rights Policy")
              ...
              (:div (:h3 "Change to these terms")
                    (:p "Our company reserves the right to change or modify current Terms with no prior notice."))
              (:div (:h3 "Questions and Suggestions")
                    (:p "If you have questions or suggestions about the Terms of Use, please " (:a :href "mailto:webmaster@golb.in" "contact us") "."))))))
...
(defun v-privacy ()
  (fe-page-template
   ...
   (htm (:div :id "articles"
              ...
              (:div (:h3 "What this privacy policy covers")
              ...
              (:div (:h3 "Collection and use of personal information")
              ...
              (:div (:h3 "Collection and use of non-personal information")
              ...
              (:div (:h3 "Information sharing and disclosure")
...
")
              ...
              (:div (:h3 "Changes to the privacy policy")
